...
public class FLogTestCase {
    ...
    public void basePrintTest(Object object){
        FLog.tag("FLog").count(8).showThread().showTime().withObject(object).print("Hello FLog ! Config : count(8).showThread().showTime().withObject(object)");
        FLog.tag("FLog").count(0).withObject(object).w().print("Hello FLog ! Config : count(0).withObject(object).w()");
        FLog.tag("FLog").excludeThis(this).print("Hello FLog ! Config : excludeThis(this)");
        FLog.tag("FLog").count(100).singleLine().showFooterLine().showHeardLine().print("Hello FLog ! Config : count(100).singleLine().showFooterLine().showHeardLine()");
